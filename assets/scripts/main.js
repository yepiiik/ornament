...
let MIN_ZOOM = SCROLL_SENSITIVITY**-4
...
function zoom(e) {
    ...
    canvasEventPosition.x = (window.event.clientX - cameraOffset.x) / cameraZoom
    canvasEventPosition.y = (window.event.clientY - cameraOffset.y) / cameraZoom

    cameraZoom *= SCROLL_SENSITIVITY**-(e.deltaY/100)

    // Move canvas
    cameraOffset.x = window.event.clientX - canvasEventPosition.x * cameraZoom
    cameraOffset.y = window.event.clientY - canvasEventPosition.y * cameraZoom
}
